...
<div class="wrapper">
	<!--шапка -->
	<header class="container-fluid header header_younger">
		<div class="container">
			<div class="row">
		...
		<div class="container ">
			<div class="row">
				<div class="col-lg-12 col-md-12 header_content">
					<?php if ( have_posts() ) : query_posts('p=155');
	...
	<section class="younger_programm_wrap">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<?php if ( have_posts() ) : query_posts('p=174');
						while (have_posts()) : the_post(); ?>
						<?php the_post_thumbnail(array(310, 170)); ?>
